...
def log_agent_history(
    ...
    validate_sql_duration: Optional[int] = None,
    memory_context_duration: Optional[int] = None,
    technical_context_duration: Optional[int] = None,
    metadata_context_duration: Optional[int] = None,
    ...
    post_params = {
        ...
        "validate_sql_duration":           validate_sql_duration,
        "memory_context_duration":         memory_context_duration,
        "technical_context_duration":      technical_context_duration,
        "metadata_context_duration":       metadata_context_duration,
        "status":                          status,
...
def log_chain_trace(
    ...
    payload = _clean({
        "trace_id":           new_trace_id(), #ctx.conversation_id or ctx.query_id,
        "query_id":           ctx.query_id,
        "agent_name":         ctx.agent_name,
